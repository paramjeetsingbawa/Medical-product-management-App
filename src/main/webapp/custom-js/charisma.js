...
function getAllBpelServiceAssembly(){
    $.ajax({
        url: "/AvonMedicalApplication-1.0/rest/BpelManagementService/bpeldetails"		
    }).then(function(data) {
        if( data && data.serviceUnit ){
            ...
            if( ! summary.bpelData ) {
                ...
                $.each(summary, function (i, theItem) {	
                    ...
                    var ur = "/AvonMedicalApplication-1.0/rest/BpelManagementService/getBpelInstanceCount?bpelId=" + theItem.bpelData.bpelId + "";
                    var c = encodeURI(ur);
                ...
                $.ajax({
                    url: "/AvonMedicalApplication-1.0/rest/openjbiservice/service_assemblies_details"		
                }).then(function(data) {
                ...
                var ur = "/AvonMedicalApplication-1.0/rest/BpelManagementService/getBpelInstanceCount?bpelId=" + summary.bpelData.bpelId + "";
                var c = encodeURI(ur);
...
function getInstanceSummaryList(){
    ...
    $.ajax({
        url: "/AvonMedicalApplication-1.0/rest/BpelManagementService/getInstanceSummaryList"		
    }).then(function(data) {
...
function getCompositeAppAndBPEL(){
    $.ajax({
        url: "/AvonMedicalApplication-1.0/rest/BpelManagementService/serviceassemblies"		
    }).then(function(data) {
...
function getBpelInstancesForBpel(id){
    ...
    var ur = "/AvonMedicalApplication-1.0/rest/BpelManagementService/getBPELInstancesWithFilter?bpelId=" + id + "&maxrecord=1000";
    var c = encodeURI(ur);
...
function addProductForBilling(){
    ...
    var amountPerUnit = document.getElementById("amountPerUnit").innerHTML;
    ...
    totalPriceForBill = totalPriceForBill + ( parseInt(amountPerUnit) * parseInt(quantity) );
...
function print_specific_div_content()
{
    ...
    var urlString = "/AvonMedicalApplication-1.0/rest/BpelManagementService/addBillingDetail?";
...
function addProduct(){
    ...
    var urlString = "/AvonMedicalApplication-1.0/rest/BpelManagementService/addProductDetail?";
...
function getCustomerInstances(sortField, sortOrder){
    ...
    var urlString = "/AvonMedicalApplication-1.0/rest/BpelManagementService/getCustomerBillingDetail?";
    ...
    $.ajax({
        ...
        if( data )            {
            ...
            $('#bpelInstSummayTabBody').pageMe({
                pagerSelector:'#bpelProcessSummayTabBodyPager2',
                showPrevNext:true,
                hidePageNumbers:false,
                perPage:10
            });
            ...
            $('#testInstCust td').click(function() {
                ...
                var urlString = "/AvonMedicalApplication-1.0/rest/BpelManagementService/getBillingDetailWithProducts?";
...
function getBpelInstances(sortField, sortOrder){
    ...
    var urlString = "/AvonMedicalApplication-1.0/rest/BpelManagementService/getProductDetail?";
    ...
    $.ajax({
        ...
        if( data )            {
            ...
            $.each(summary, function (i, theItem) {						
                ...
                row.append($("<td id='" +rowid + "_formula" + "'>").text(theItem["formula"]));		
                row.append($("<td id='" +rowid + "_batchNo" + "'>").text(theItem["batchNo"]));		
                row.append($("<td id='" +rowid + "_manufactureDate" + "'>").text(theItem["manufactureDate"]));		
        ...
        $('#tabBpelVariableList tr').click(function() {
            alert($(this).attr('id'));
...
$(document).ready(function(){
    ...
    var processed_json = new Array();   
                $.getJSON('/AvonMedicalApplication-1.0/rest/BpelManagementService/json', function(data) {
...
$('#uploadButton').click(function(){
    ...
    if( file ){
        ...
        if( type == "csv" || type == "CSV"){
            ...
            $.ajax({
                url: '/AvonMedicalApplication-1.0/rest/BpelManagementService/upload',  //Server script to process data
                type: 'POST',
        ...
        alert("No file chosen for upload !! Upload aborted!!");
    }
});
